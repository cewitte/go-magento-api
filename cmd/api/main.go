...
func main() {
	...
	// Declare a HTTP server with some sensible timeout settings, which listens on the port provided in the config struct and uses the app.routes() as the server handler.
	srv := &http.Server{
